...
export default function InicioMain() {
  return (
    <section className="mx-auto max-w-auot px-4 py-16 bg-orange-950 min-h-screen">
      <div className=" md:grid-cols-12 gap-10 items-center">        
        ...
        <div className="md:col-span-5 flex flex-col gap-6">
          ...
          <ChatMockup />
          <button className="w-full bg-orange-800 hover:bg-teal-900 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline transition duration-200">
            Carga tus archivos
          </button>
        </div>
      </div>
